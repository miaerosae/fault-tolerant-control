...
default_settings = fym.parser.parse({
    ...
    "agents.BLF": {
        ...
        # --- gain K --- #
        # BLF Gain
        "Kxy": np.array([9.39, 0.29, 1.00]),
        "Kang": np.array([18.97, 155.86, 0.91]),
        "theta": 0.7,

        # --- peaking-free --- #
        "pf.oL": {
            "l": np.array([50, 70, 40]),
            "alp": np.array([2.9, 2.9, 5]),
            "alp_y": np.array([2.9, 2.9, 5]),
        ...
        "pf.iL": {
            ...
            "dist_range_theta": 100,  # disturbance saturation value
